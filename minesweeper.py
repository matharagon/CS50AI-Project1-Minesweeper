    ...
    def add_knowledge(self, cell, count):
        ...
        for i in range(cell[0] - 1, cell[0] + 2):
            for j in range(cell[1] - 1, cell[1] + 2):
                ...
                # ignore mine cells and count which are mines
        ...
        new_sentence = Sentence(new_cells, count - count_mines)
        self.knowledge.append(new_sentence)

        # Check if there are any cells that are known to be either safe or mines
        for sentence in self.knowledge:
        ...
        # Use the inference method to find new sentences and add to knowledge
        for sentence in self.knowledge:
